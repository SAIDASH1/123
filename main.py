...
vk_token = "2598d0265b0719bfa5d9a7c9db7256f715c90286e67d4be9572bc0ca7a1033b62772aa2dfb0457aab29b0"
# Сюда вставляешь свой токен. (Я юзал от кейта. Получить можно тут https://vkhost.github.io )

contest_trigger_list = ('ротелу даун', 'жопа', 'аккерман')  # Листик слов триггеров для уведомления о розыгрыше:
...
layout_swap_trigger = (
    "лячь"  # Триггер слово в кавычках, с маленькой буквы для смены раскладки на последнем сообщении.
)

chat_everyone_trigger = (
    "эй все"  # Триггер для оповещения всех в беседе.
)

mention_answer_list = (
    "Сайгаш",  # Триггер для автоответчика в кавычках;
    [50249, 50237, 50220, 11103, 11107, 8662],  # [1, 2, 3] - Заполняете в скобках id стикеров для ответа;
    False,  # Установите True, чтобы использовать упоминание как дополнительный триггер (наприм. @durov)
    120  # Минимальное время (в секундах) между старой и новой "реакцией" на сообщение
)
